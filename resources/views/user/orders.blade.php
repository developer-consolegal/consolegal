      ...
      <table class="table table-striped custab">
        ...
        <tr>
          ...
          <td class="text-center">
            ...
            @if($order->form_submitted == 5 || $order->form_submitted == 3)
            ...
            @if($order->form_status == 'Pending')
            <a class="btn text-white btn-danger">Pending</a>
            @endif
            
            @if($order->form_status == 'In Process')
            <a class="btn text-white btn-success">In Process</a>
            @endif
            
            @if($order->form_status == 'Not Assigned')
            <a class="btn text-white btn-info">Not Assigned</a>
            @endif
          </td>
