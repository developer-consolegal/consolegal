...
<div class="main-container" id="container">
   ...
   <div id="content" class="main-content">
      <div class="addform-page addorder">
         <h2>App Sliders</h2>
         <form action="{{ route('admin.sliders.store') }}" class="mb-5" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <button type="submit" class="btn btn-warning text-white">Add Slider</button>
        </form>
