...
<nav class="navbar navbar-expand-lg navbar-light bg-white sticky-nav sticky-top flex-column" id="navbarWeb">
   <div class="container-fluid px-3 border-bottom-md">
      <a class="navbar-brand" href="/"><img src="{{ asset('web/image/logo.jpeg')}}" alt="" width="auto"
            height="65px"></a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContentMobile"
...
<script>
   $(document).ready(function () {
       $('#navbarSupportedContentMobile .nav-item.dropdown .nav-link').click(function (e) {
           e.preventDefault();
           console.log($(this));
