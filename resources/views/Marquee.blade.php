...
<div class="main-container" id="container">
   ...
   <div id="content" class="main-content">
      <div class="addform-page addorder">
         <h2>Marquee</h2>
         @if(isset($data))
         <form action="{{route('admin.marquee.set', ['id' => $data->id])}}" method="post">
            @else
         <form action="{{route('admin.marquee.set')}}" method="post">
         @endif
            @csrf
            ...
            <div class="form-group">
               ...
               <input type="text" class="form-control" name="label" value="{{$data ? $data?->label : ''}}" required="">
            </div>
