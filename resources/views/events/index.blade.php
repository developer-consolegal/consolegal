      ...
      <div class="addform-page addorder">
         ...
         <table class="table table-striped custab">
            ...
            <tbody>
                ...
                @php($nos++)
                <tr>
                    <td><img src="{{ asset('storage/' . $event->image) }}" alt="{{ $event->label }}" width="100"></td>
                    <td>
                     <a href="{{route('events.edit', $event->id)}}" class="d-flex align-items-center">
                        {{ $event->label }}
                     </a>
                    </td>
                    <td>{{ $event->description }}</td>
                    <td>{{ $event->event_date }}</td>
                    <td><a href="{{ $event->link }}" target="_blank">View Details</a></td>
