...
<body class="loginbody" style="background-image: url({{ asset('user/images')}}/login_full_bg.jpg);">
            ...
            <div class="col-lg-4 col-md-6">
               <div class="login-page bg-white shadow rounded p-4">
                  <div class="text-center">
                     <h4 class="mb-4">Franchise Login</h4>

                  </div>
                  <form class="login-form" method="POST" action="{{route('fran.login')}}">
                     @csrf
                     <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-6  fp mb-3">
   ...
   <script>
      ...
      //             location.href = '/franchise/dashboard';
      //          } else if (data.status == "password_err") {
      //             $(".password_err").html("Wrong Password !!");
      //          } else if (data.status == "email_err") {
      //             $(".email_err").html("Wrong email !!");
      //          } else if (data.status == "empty_err") {
      //             $(".email_err").html("Email should be filled !!");
      //             $(".password_err").html("Password should be filled !!!");
      //          }
      //       },
      //       complete: function() {
