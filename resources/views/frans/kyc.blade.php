...
@section('content')
          ...
          <div class="tab-pane active text-style" id="tab1">
            <form class="login-form" action="{{route('franchise.kyc.update',['id' => $kyc->id])}}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="row rightcol">
                <!-- name -->
                <input type="hidden" name="user_type" value="frans">
                <input type="hidden" name="user_id" value="{{$frans->id}}">
          ...
          @else
          <div class="tab-pane active text-style" id="tab1">
            <form class="login-form" action="{{route('franchise.kyc.upload')}}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="row rightcol">
                <!-- name -->
                <input type="hidden" name="user_type" value="frans">
